    ...
    <>
      ...
      <div className="w-screen h-screen flex justify-end items-center gap-5 p-5">
        {!decipherClicked && (
          ...
          >
            <p>
              Adam&apos;s vision blurred as he stumbled through the wreckage of his crashed ship, his hands slick with blood...
            </p>
            <p className="font-light text-xl text-gray-100 italic">
              ADM303: &ldquo;Your location is compromised. You must move. Decipher the coordinates...&rdquo;
            </p>
            <p className="text-gray-100">
              <span className="font-bold">Frankfurt</span> and <span className="font-bold">Stuttgart</span> are the closest cities.
            </p>
            <p className="text-gray-200 italic">&ldquo;Adam, we have to move. Now.&rdquo;</p>
            <p className="text-gray-100 text-3xl uppercase font-bold my-7 font-neueMachina tracking-wider">
              Help Adam decipher the image to find the basecamp.
            </p>
          </motion.div>
        )}
        ...
        >
          ...
          />
          {!decipherClicked ? (
            <ClickButton text="Decipher" buttonColor="#DD0000" textColor="white" shadowColor="white" goTo={decipher} />
          ) : (
            <div className="w-full flex flex-col items-center">
              ...
              <ClickButton text="Submit" buttonColor="#94FFA9" textColor="black" shadowColor="white" goTo={checkInput} />
            </div>
          )}
        </motion.div>
        ...
        <AnimatePresence>
          {showWrongAlert && (
            ...
            >
              ...
              >
                <h2 className="text-[#FF2222] text-lg font-neueMachina tracking-wider font-bold">WRONG INPUT</h2>
                <p className="text-[#FF2222] text-lg mt-2 font-montserrat font-medium">
                  That&apos;s the wrong answer. Try again. <br /> Remember, the answer is in the message.
                </p>
                <button
        ...
        {decipherClicked && (
          <motion.div
            ...
            transition={{ duration: 1 }}
          >
            <Image src="/images/imitationGame.png" layout="fill" objectFit="cover" alt="stg3-1" className="pointer-events-none" />
          </motion.div>
        )}
      </div>
    </>
